...
> **Update, 2026-09-23:** the fork's modernisation work is now proposed as several smaller releases (`0.3.0`, `0.4.0`, `0.4.1`, `0.5.0`, then `0.6.0` for the work in progress; see [CHANGELOG.md](../CHANGELOG.md)). That makes the package split the next minor after those, not `0.4.0`. The bump-level rules and the 1.0.0 criteria now live in [CLAUDE.md § Versioning](../CLAUDE.md#versioning).
